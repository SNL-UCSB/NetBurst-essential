...
#SBATCH --job-name=netburst_pre_rne_netflow_svc
...
PARQUET_ROOT="<data-root>/output/splits_60s_rne_netflow_service/ibgbi_train"
...
SAVE_DIR="${PRETRAIN_CKPT_ROOT}/NetBurstIBGBI_service_60s_rne_netflow_netburst_CE_intK_manifest"
EPOCHS=100
BATCH_SIZE=16
MAX_LEN=512
TRAIN_FRAC=0.8
...
echo "Starting NetBurst pretraining (NetBurst-essential pretrain_twin.py): rne_netflow_service_60s (CE + IntegerIBGBins + per-head projections)"
