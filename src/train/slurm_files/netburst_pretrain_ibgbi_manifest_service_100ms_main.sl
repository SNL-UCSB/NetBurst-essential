...
#SBATCH --job-name=netburst_pre_service_100ms_main
...
PARQUET_ROOT="<data-root>/output/splits_100ms_service/ibgbi_train"
...
SAVE_DIR="${PRETRAIN_CKPT_ROOT}/NetBurstIBGBI_service_100ms_main_netburst_CE_intK_manifest"
EPOCHS=100
BATCH_SIZE=16
MAX_LEN=128
TRAIN_FRAC=0.8
...
echo "Starting NetBurst pretraining (NetBurst-essential pretrain_twin.py): service_100ms_main (CE + IntegerIBGBins + per-head projections)"
