...
#SBATCH --job-name=netburst_pre_ip_1s_mawi
...
PARQUET_ROOT="<data-root>/output/splits_1s_mawi_ip/ibgbi_train"
...
SAVE_DIR="${PRETRAIN_CKPT_ROOT}/NetBurstIBGBI_ip_1s_mawi_netburst_CE_intK_manifest"
EPOCHS=100
BATCH_SIZE=16
MAX_LEN=512
TRAIN_FRAC=0.8
...
echo "Starting NetBurst pretraining (NetBurst-essential pretrain_twin.py): ip_1s_mawi (CE + IntegerIBGBins + per-head projections)"
